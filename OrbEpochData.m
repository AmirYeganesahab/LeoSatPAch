classdef OrbEpochData < handle
    ...
    methods
        function this=OrbEpochData(obs,svn,gpsPos,gpsClcCorr,epochFateTime,hFlag,gpsTgd)
        % FUNCTION
        ...
        %                   satellites
        %   epochFateTime : Array including date and time, such as;
        %                    EpochFateTime=[year month day hour minute second]
        ...
        % Store the data
          ...
          this.epochFateTime=epochFateTime;
          this.hFlag=hFlag;
          this.gpsTgd=gpsTgd;
